...
class enhanceBaseMaskHead(BaseModule, metaclass=ABCMeta):
    ...
    def loss(self,
             ...
             batch_data_samples: SampleList, box_feature,
        ...
        if positive_infos is None:
            outs = self(x, box_feature)
        else:
            outs = self(x, positive_infos,box_feature)
    ...
    def predict(self,
        ...
        if results_list is None:
            outs = self(x, box_feature, batch_img_metas)
        else:
            outs = self(x, results_list, box_feature)
